...
public class DBConnectionManager {
	...
	private static final String URL = "jdbc:mysql://localhost:3306/mydb4?serverTimezone=Asia/Seoul";
	private static final String USER = "root";
	private static final String PASSWORD = "asd123";

	// static {} 블록 - 정적 초기화 블록
	// 클래스가 처음 로드될 떄 한번 실행 됩니다.
	// 정적 변수의 초기화나 복잡한 초기화 작업을 수행할 떄 사용할 수 있다.
